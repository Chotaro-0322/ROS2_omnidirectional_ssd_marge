...
class Object_Detection(Node):
    def __init__(self):
        ...
        net_weights = torch.load("/home/seniorcar/Desktop/Yamamoto/ROS2_detection/src/ssd_detection/ssd_detection/weight/201111_ssd300_VOTT_split4_201031_1_100000.pth", 
    ...
    def detection(self, img, ssd, only_front=True):
        #print(img.shape)
        img, predict_bbox, predict_label_index, score = ssd.ssd_panorama_predict(img, only_front , data_confidence_level=0.5)
        print(len(predict_bbox))
        img = img[:, :, [0, 1, 2]]
